...
"[project]/src/lib/api-config.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (token) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/users/me').then((res)=>{
                setUser(res.data);
            }).catch((error)=>{
    ...
    const login = async (email, password)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/users/login', {
                email,
                password
            });
    ...
    const register = async (username, email, password)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/users/register', {
                username,
                email,
                password
            });
...
;
;
function AuthModal({ isOpen, onClose, onLogin, onRegister, initialMode = 'login' }) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02bgl54._.js.map