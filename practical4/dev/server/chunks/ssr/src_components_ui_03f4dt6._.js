...
function VideoCard({ post }) {
    ...
    // Placeholder data with defaults
    const { username = 'user123', caption = 'No caption', audio = 'Original Audio', likes = 0, comments = 0, shares = 0 } = post || {};
...
//# sourceMappingURL=src_components_ui_03f4dt6._.js.map